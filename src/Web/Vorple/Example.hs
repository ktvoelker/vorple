...
If you are looking at this example in the Haddock documentation for
Web.Vorple.Example, it was generated automatically from @example/Simple.lhs@ in the
Vorple source code repository, which the Cabal configuration for Vorple will build as
an executable called @vorple-example-simple@.
...
-}
module Web.Vorple.Example where
